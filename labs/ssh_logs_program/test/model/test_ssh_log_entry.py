...
class TestFailedPassword:
    ...
    def test_failed_password_properties(self, entry, properties):
        ...
        assert instance.host == properties[0]
        assert instance.get_ipv4_address() == properties[1]
        assert instance.port == properties[2]

    def test_validate(self):
        instance = ssh_log_entry.FailedPassword("Dec 13 11:00:21 LabSZ sshd[5459]: Failed password for zachary from 218.17.80.182 port 50313 ssh2")
        assert instance.validate()
